...
const METHODS = ['Bank Transfer', 'Cash', 'UPI']
const METHOD_MAP = { 'Bank Transfer': 'bank', 'Cash': 'cash', 'UPI': 'upi' }
      ...
      <div className="px-5 pt-14 pb-4 bg-white sticky top-0 z-10 border-b border-gray-50">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-[20px] font-bold font-display text-[#2B1D1C] leading-tight">Log Payment</h1>
            <p
      ...
      <div className="screen-body px-5">
        <div className="mt-5 space-y-5">
          ...
          <div className="bg-[#F5F5F5] rounded-3xl p-5">
            <p className="text-[11px] font-bold text-[#A0A0A0] tracking-wider uppercase mb-3">Amount Received</p>
          ...
          {/* Payment Method */}
          <div className="bg-[#F5F5F5] rounded-3xl p-5">
            <p className="text-[11px] font-bold text-[#A0A0A0] tracking-wider uppercase mb-3">Payment Method</p>
          ...
          {/* Date & Note */}
          <div className="bg-[#F5F5F5] rounded-3xl p-5">
            <p className="text-[11px] font-bold text-[#A0A0A0] tracking-wider uppercase mb-3">Date of Receipt</p>
            <input
            ...
            <p className="text-[11px] font-bold text-[#A0A0A0] tracking-wider uppercase mb-3">Reference / Note</p>
            <textarea
